              ...
              <div className="col-md-6 text-end">
                <span className={styles.icon_right}>
                  ...
                  <Image
                    ...
                    width={4.92}
                  />
                  {/* <img  className={styles.right_icon} /> */}
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-6 text-end">
                <div className="row">
                  ...
                  <div className="col-md-2 col-6">
                    <button className="btn w-100 btn-danger btn-sm rounded-pill">
                      <span className={styles.icons_add}>
                        {" "}
                        <Image
          ...
          <div className="col-md-12 px-3">
            <div className="row">
              <div className="col-md-8">
                <p className={styles.app_text_paragrapg}>
                  Dear customer please choose your desired address from where
                  you want to get nearest clinic addresses
                </p>
              </div>
              ...
              <div className="col-md-8">
                ...
                <p className={styles.app_text_paragrapg11}>
                  <i
                    ...
                    aria-hidden="true"
                  ></i>{" "}
                  Dont worry, your information is private and we will not share
