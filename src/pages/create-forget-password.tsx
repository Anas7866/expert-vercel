...
import { PasswordAction, resetUserPassword } from "@/helper";
...
function CreateForgetPassword() {
  ...
  const handleClick = (e: any) => {
    ...
    if (confirmPassword !== passwordValue) {
      ...
      setLoader(true);
      resetUserPassword(query.userId, passwordValue, userOTP).then((result) => {
        setLoader(false);
        if (result?.code === 0) {
      ...
      >
        <Item width={"35%"}>
          <img
            ...
            src={`https://1864597015.rsc.cdn77.org/newexpertpreprod/Images/LoginBg.png`}
          />
          <img
            alt=""
            style={{
