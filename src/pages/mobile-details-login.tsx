...
import {
  ...
  VerifyUserMobileSecondaryAction,
} from "@/helper";
...
const Profile_page = () => {
  ...
  const handleEmailClickSecondary = () => {
    // if profile.email is verified --> just go
    // : send otp sms and on success --> go to otp page:
    router.push("/secondary-mobile-add");
    // , {
    //   query: { isVerified: false },
    // });
    return;
    VerifyUserMobileSecondaryAction({ userId: profile.userId, type: 2 }).then(
      (resp) => {
        console.log("---- response send email otp ---------");

        console.log(resp);
        console.log("---- response send email otp ---------");
        router.push("/secondary-mobile-otp-verify");
      }
    );
  };
  const sideMenu: any = [
        ...
        <div className="row">
          ...
          <div className="col-md-9 ">
            ...
            >
              ...
              <div className="col-md-12 pt-3">
                ...
                <div className="col-md-12 ">
                  <h6 className="email_font_screen_sub">
                    The mobile number used to identify your expert account to
                    you. You can't change this address.
                  </h6>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-end">
                    ...
                    <p
                      ...
                      onClick={(e) =>
                        !profile?.primaryMobileVerify && handleEmailClick()
                      }
                    >
              ...
              <div className="col-md-12 pt-3">
                <div className="col-md-12 ">
                  <h6 className="email_font_screen">Secondary Mobile Number</h6>
                </div>
                <div className="col-md-12 ">
                  <h6 className="email_font_screen_sub">
                    The mobile number where expert can contact you if there's
                ...
                {profile?.secondaryMobile ? (
                  ...
                  <Link href="/secondary-mobile-add" className="a_style">
                    <h6 className="recovery_text_red">
