      ...
      <div className="container px-md-5 pt-2">
          ...
          <div className="col-md-12 px-3 ">
            ...
            <div className={styles.flex_image}>
              ...
              <div className={styles.margin_autoo}>
                ...
                <p className={styles.sunspots1}>
                  <b className={styles.text_decoration_overline}>£72</b>{" "}
                  <b className={styles.text_new_price}>£20</b>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className={styles.borders_div}>
          <div className="col-md-12 px-3 ">
            ...
            <div className="col-md-12 mt-2 mb-3">
              <div className="row ">
                {button ? (
                  ...
                  >
                    <div className={styles.text_right_div}>
                      <Image
                        className={styles.img_fluid_cross}
                        alt="cross"
                ...
                <div className="col-md-2 col-6">
                  <button className={styles.button_disabled}>Eyebrows</button>
                </div>
                <div className="col-md-2 col-6">
                  <button className={styles.button_disabled}>Navel</button>
                </div>
                <div className="col-md-2 col-6">
                  <button className={styles.button_disabled}>Nostril</button>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <button className="btn btn-danger btn-sm bg-red">
                {" "}
                Save & Continue{" "}
              </button>
            </div>
